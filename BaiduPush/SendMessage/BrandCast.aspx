<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BrandCast.aspx.cs" Inherits="BaiduPush.SendMessage.BrandCast" %>
...
<body>
    <form id="form1" runat="server" style="margin: 0 auto; margin-top:100px;width:80%;">
        ...
        <div class="form-group">
            <asp:Button ID="btn_Send" CssClass="btn btn-success" runat="server" Text="广播" OnClick="btn_Send_Click" />
        </div>
        <br />
